...
BP = 0
# path='save_epoch/p2p_blockM_position_type/epoch'+str(BP)+'.pickle'
...
for epoch in range(epochs):
    for linkM, blockM, position_graph, position_seq, position_real, node_type, order in loader:
        ...
        txt_file = open('loss/loss_p2p_blockM_position_type.txt', "a", encoding="utf-8")
    ...
    if epoch % 100 == 1:
        for p in optimizer.param_groups:
            p['lr'] *= 0.95
        path = 'save_epoch/p2p_blockM_position_type/epoch' + str(BP + epoch - 1) + '.pickle'
